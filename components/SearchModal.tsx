...
function getTimeGroup(dateString) {
  ...
  if (date >= sevenDaysAgo) return "최근 7일"
  return "이전"
}
            ...
            <div className="max-h-[60vh] overflow-y-auto">
              ...
              {filteredConversations.length === 0 && query.trim() && (
                <div className="p-8 text-center">
                  ...
                  <div className="mt-4 text-lg font-medium text-zinc-900 dark:text-zinc-100">검색 결과가 없습니다</div>
              ...
              {!query.trim() && conversations.length === 0 && (
                <div className="p-8 text-center">
                  <div className="text-lg font-medium text-zinc-900 dark:text-zinc-100">아직 대화가 없습니다</div>
                  <div className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">새 채팅으로 시작해 보세요</div>
                </div>
              )}
            </div>
          </motion.div>
