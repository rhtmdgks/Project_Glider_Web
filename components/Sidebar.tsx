  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cls(
          "z-50 flex h-full w-[85vw] max-w-80 shrink-0 flex-col border-r border-zinc-200/60 bg-white transition-transform duration-200 dark:border-zinc-800 dark:bg-zinc-900",
          "fixed inset-y-0 left-0 md:static",
          open ? "translate-x-0" : "-translate-x-full md:translate-x-0",
          !open ? "pointer-events-none md:pointer-events-auto" : "pointer-events-auto",
        )}
      >
            <div className="flex items-center gap-2 border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-semibold tracking-tight">Glider</div>
              </div>
              ...
              >
                <div className="-mx-1">
                  <button
                    ...
                    className="mb-2 inline-flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-sm text-zinc-600 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800"
                  >
                    <Plus className="h-4 w-4" /> 템플릿 만들기
                  </button>
            ...
            <div className="mt-auto border-t border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <Link
                  href="/settings"
                  className="inline-flex items-center gap-2 rounded-lg px-2 py-2 text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800"
                >
                  관리
                </Link>
                <Link
              ...
              <div className="mt-2 flex items-center gap-2 rounded-xl bg-zinc-50 p-2 dark:bg-zinc-800/60">
                ...
                <div className="min-w-0">
                  ...
                  <div className="truncate text-xs text-zinc-500 dark:text-zinc-400">프로 워크스페이스</div>
                </div>
              </div>
            </div>
      </motion.aside>
