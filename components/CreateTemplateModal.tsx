        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold">{isEditing ? "템플릿 수정" : "템플릿 만들기"}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="예: 이메일 답변, 코드 리뷰, 회의록"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="템플릿 내용을 입력하세요. 템플릿을 사용할 때 채팅 입력창에 자동으로 삽입됩니다."
                  rows={8}
              ...
              <div className="flex items-start gap-3 rounded-lg bg-zinc-50 p-4 dark:bg-zinc-800/50">
                ...
                <div className="text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <div>
                    템플릿은 자주 쓰는 프롬프트, 지침, 시작 문구를 저장할 때 유용합니다. 선택하면 채팅 입력창에 바로
                    들어갑니다.
                  </div>
                </div>
              </div>
